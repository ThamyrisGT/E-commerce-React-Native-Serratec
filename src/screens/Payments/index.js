  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputPay}>
        <View style={styles.inputPay}>
          <Input textContentType={'text'} placeholder={'Número do cartão'} />
        </View>
        <View style={styles.inputPay}>
          <Input textContentType={'text'} placeholder={'Nome'} /> 
        </View >
        <View style={styles.inputPay}>
           <Input textContentType={'text'} placeholder={'Validade do cartão'} /> 
        </View>
        <View style={styles.inputPay}>
          <Input textContentType={'password'} placeholder={'Senha do cartão'} />
        </View>
      </View>
